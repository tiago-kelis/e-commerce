...
export default function FormularioEntrega(props: FormularioEntregaProps) {
    ...
    return (
        <div className={`flex flex-col gap-3 ${props.className ?? ''}`}>
            ...
            <div className="flex flex-col gap-5 bg-purple-950 rounded-xl p-6">
                <input
                ...
                <div className="flex gap-5">
                    <input
                        ...
                        className="input flex-1  p-2 rounded-lg border border-zinc-950"
                    />
                    <input
                        placeholder="CPF"
                        value={entrega.cpf}
                ...
                <div className="flex gap-5">
                    ...
                    <input
                        ...
                        className="input p-2 rounded-lg border border-zinc-950"
                    />
                </div>
                <div className="flex gap-5">
                    <input
