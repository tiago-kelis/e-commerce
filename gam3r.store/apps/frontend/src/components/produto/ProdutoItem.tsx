...
export default function ProdutoItem(props: ProdutoItemProps) {
    ...
    return (
        <Link
            ...
            className="flex flex-col bg-purple-950 border border-white/10 rounded-xl relative max-w-[350px]"
        >
            ...
            <div className="flex-1 flex flex-col gap-3 p-5 border-t border-white/10">
                ...
                <button
                    className="
                      ...
                      bg-violet-700 hover:border-2 border-emerald-500 rounded-full cursor-pointer
                    "
                    onClick={(e) => {
                        e.preventDefault()
