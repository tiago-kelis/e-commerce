...
export default function CarrinhoItem(props: CarrinhoItemProps) {
    ...
    return (
        <div className="flex items-center bg-purple-950 px-8 py-0 rounded-xl gap-16">
            <Image
                src={produto.imagem}
                width={200}
                height={0}
            ...
            <div className="flex flex-col items-center gap-4">
                ...
                <div className="flex items-center border border-zinc-300 rounded-lg">
                    <button
                        ...
                        className={`${quantidade === 1 && 'text-zinc-500 cursor-not-allowed'} px-2 py-0.5 cursor-pointer`}
                    ...
                    <button
                        className="px-2 py-0.5 text-emerald-500 cursor-pointer"
                ...
                <button
                    className="flex items-center gap-1 text-pink-600 select-none cursor-pointer"
